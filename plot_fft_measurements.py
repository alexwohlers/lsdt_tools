...
Beispiele:
  - Einfache Gegenüberstellung:
      python plot_fft_measurements.py --file sample.csv
  - Mit Titel und Log-Skala im Frequenzbereich:
      python plot_fft_measurements.py --file sinus.csv --title "FFT-Analyse" --log
  - Nur bis 50 Hz anzeigen:
      python plot_fft_measurements.py --file data.csv --fmax 50
  - Als PNG speichern:
      python plot_fft_measurements.py --file signal.csv --save analysis.png
  - Phase auch anzeigen (3 Subplots):
      python plot_fft_measurements.py --file sample.csv --phase
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--save", dest="save_path", help="Dateiname für Plot (ohne Pfad, wird in plots/ gespeichert)")
