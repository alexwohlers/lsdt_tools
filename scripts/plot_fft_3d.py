...
def main() -> None:
    ...
    time_file = os.path.join("..", "data", "measurements", f"{args.name}.csv")
    fft_file = os.path.join("..", "data", "fft", f"{args.name}.csv")
    ...
    if args.save_path:
        if not os.path.dirname(args.save_path):
            save_path = os.path.join("..", "bilder", "plot_fft_3d", args.save_path)
        else:
            save_path = args.save_path
    else:
        save_path = os.path.join("..", "bilder", "plot_fft_3d", f"{args.name}_3d.png")
